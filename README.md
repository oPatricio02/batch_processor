...
A aplicação foi desenvolvida para ler os dados dessa base e gerar uma nova, contendo apenas as informações que agregam valor e podem ser úteis para gestores e analistas de negócios.
